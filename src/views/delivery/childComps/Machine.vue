...
import { showDeliveryMachineList, deleteDelivery } from '@/network/delivery.js'
export default {
  name: 'Delivery',
  components: {
    JqxGrid,
  ...
  beforeCreate() {
    this.source = {
      ...
      sortdirection: 'desc',
      id: 'id',
      url: `/dlvDtl/showDeliveryMachineList.do`,
    }
  },
  data() {
    return {
      ...
      dataAdapter: new jqx.dataAdapter(this.source, {
        ...
        loadServerData: function (serverdata, source, callback) {
          ...
          showDeliveryMachineList(source, serverdata).then((res) => {
            callback({
              records: res.rows,
  ...
  methods: {
    createButtonsContainers: function (toolbar) {
      ...
      exportInstance.addEventHandler('click', () => {
        ...
        dataExport('送货-设备.xlsx', columns, rowsData, {
          rowConfig: {
            start: 30,
            end: 30,
            other: 30,
