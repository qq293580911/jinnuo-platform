export const Message = {
  ...
  NO_OBJECT_SELECTED: '未选择对象',
  UNSELECTABLE_NODE: '不可选择的节点',
  LIMIT_ONE_ROW: '只能选择一行',
...
export const ADD_SUPPLIES_RECEIVE = '添加用品领用信息'
export const EDIT_SUPPLIES_RECEIVE = '修改用品领用信息'
