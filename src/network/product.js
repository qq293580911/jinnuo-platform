...
export function getAllVentilator() {
  return request({
    url: '/productManage/getAllVentilator.do',
    method: 'Get',
  })
}
...
// 换气扇价格
export function showVentilatorPrice(source, params) {
  return request({
    url: source.url,
    method: source.type,
    source,
...
export function addVentilatorPrice(params) {
  return request({
    url: '/productPrice/addVentilatorPrice.do',
    method: 'Post',
    data: params,
  })
}

export function deleteVentilatorPrice(params) {
  return request({
    url: '/productPrice/deleteVentilatorPrice.do',
    method: 'Delete',
    data: params,
  })
}

export function updateVentilatorPrice(params) {
  return request({
    url: '/productPrice/updateVentilatorPrice.do',
    method: 'Put',
    data: params,
  })
}
