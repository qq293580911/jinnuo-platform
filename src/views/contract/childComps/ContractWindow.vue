...
export default {
  ...
  mounted() {
    ...
    const $originalPrice = this.$refs.myForm.getComponentByName(
      "originalPrice"
    );
    const $discountPrice = this.$refs.myForm.getComponentByName(
      "discountPrice"
    );
    ...
    const $riseDropPoint = this.$refs.myForm.getComponentByName(
      "riseDropPoint"
    );
