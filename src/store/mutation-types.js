...
export const SAVE_PURCHASERS = 'save_purchasers'
// 报价处理
...
export const SAVE_CURRENT_QUOTE_PRIMARY_GRID_ROW_DATA =
...
export const UPDATE_CURRENT_QUOTE_CONTENT = 'update_current_quote_content'
export const APPEND_CURRENT_QUOTE_CONTENT = 'append_current_quote_content'
export const SAVE_TODAY_QUOTE = 'save_today_quote'
export const REMOVE_TODAY_QUOTE = 'remove_today_quote'
